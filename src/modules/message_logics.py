...
async def audio_handler(update: Update, _context: ContextTypes.DEFAULT_TYPE) -> None:
    assert update.effective_chat and update.message and update.effective_user
...
async def video_handler(update: Update, _context: ContextTypes.DEFAULT_TYPE) -> None:
    assert update.effective_chat and update.message and update.effective_user
...
async def sticker_handler(update: Update, _context: ContextTypes.DEFAULT_TYPE) -> None:
    assert update.effective_chat and update.message and update.effective_user
    await update.message.reply_text(DIC["sticker"])


async def location_handler(update: Update, _context: ContextTypes.DEFAULT_TYPE) -> None:
    assert update.effective_chat and update.message and update.effective_user
    await update.message.reply_text(DIC["location"])


async def contact_handler(update: Update, _context: ContextTypes.DEFAULT_TYPE) -> None:
    assert update.effective_chat and update.message and update.effective_user
